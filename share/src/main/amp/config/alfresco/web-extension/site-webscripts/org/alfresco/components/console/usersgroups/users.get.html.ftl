...
<#-- JavaScript Dependencies -->
    ...
    <@script src="${url.context}/res/js/components/console/users.js" group="console"/>
        ...
        <div id="${el}-create" class="hidden">
            ...
            <form id="${el}-create-form">
                <div id="${el}-create-main" class="create-main">
                    ...
                    <div class="field-row">
                        <span class="crud-label">${msg("label.middlename")}:</span>
                    </div>
                    <div class="field-row">
                        <input class="crud-input" id="${el}-create-middlename" type="text" maxlength="256" />
                    </div>
                    <div class="field-row">
        ...
        <div id="${el}-update" class="hidden">
            ...
            <form id="${el}-update-form">
                <div id="${el}-update-main" class="update-main">
                    ...
                    <div class="field-row">
                        <input class="crud-input" id="${el}-update-middlename" type="text" maxlength="256" />
                    </div>
                    <div class="field-row">
                        <span class="crud-label">${msg("label.lastname")}:</span>
                    </div>
