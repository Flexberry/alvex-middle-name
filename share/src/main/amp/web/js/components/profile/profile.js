...
(function()
{
    ...
    * @return {Alvex.UserProfile} The new UserProfile instance
    * @constructor
    */
   Alvex.UserProfile = function(htmlId)
   {
      Alvex.UserProfile.superclass.constructor.call(this, "Alvex.UserProfile", htmlId, ["button"]);
      return this;
   };
   
   YAHOO.extend(Alvex.UserProfile, Alfresco.component.Base,
   {
      /**
